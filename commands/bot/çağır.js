...
module.exports = class mesajCommand extends Command {
    constructor(client) {
        super(client, {
            ...
            group: 'bot',
            memberName: 'çağır',
            description: `Bot sahibini (Ceyhun'u) çağırır.`,
        });
    }
...
async run(message) {
    ...
    message.reply(`${this.client.emojis.get('405702872978948096')} Sahibim çağırıldı! Sahibim yakında sunucunuza gelecektir.`);
    ...
    .setTimestamp()
    this.client.users.get(`405702872978948096`).send(embed);
}
}
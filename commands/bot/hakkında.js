...
module.exports = class EmbedCommand extends Command {
    ...
    async run(message) {
		...
		.addField(`❯ Botun Sahibi/Yapımcısı:`, `<@405702872978948096>`)
		...
		**• Node:** ${process.version}
		`)
		.addField(`❯ Botun Linkleri:`, `**[Botu sunucuna eklemek için tıkla!](https://discordapp.com/oauth2/authorize?client_id=490135723727650816&scope=bot&permissions=2146958847) \n[Botun sitesine bakmak için tıkla!](**Yakında**)**`)

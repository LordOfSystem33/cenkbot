...
module.exports = class SupportCommand extends commando.Command {
  constructor(client) {
    super(client, {
      ...
      description: 'Esquire Bot Destek Ekibi ile görüşmeye bağlanırsınız.',
      details: oneLine `
              Esquire Bot ile ilgili yardıma ihtiyacınız var mı?
  ...
  async run(message) {
    ...
    message.reply(`${this.client.emojis.get('464406478153973770')} Esquire Desteği ile iletişim kurduğunuz için teşekkür ederiz! Herhangi bir destek yetkilisi varsa, yakında sizinle iletişim kuracaktır.`)
    ...
    const embed = new RichEmbed()
      ...
      .setFooter('Esquire canlı-destek sistemi')
      .setTimestamp()
